  ...
  render () {
    return (
      <div className={styles.priceTicker}>
        <PriceTick symbol='DOW' price={17675.16} deltaPrice={-57.94} deltaPercent={-0.33}
          priceTicks={dowData}/>
        <PriceTick symbol='S&P 500' price={2071.22} deltaPrice={-6.77} deltaPercent={-0.33}
          priceTicks={spData}/>
        <PriceTick symbol='NASDAQ' price={4800.34} deltaPrice={44.58} deltaPercent={-0.92}
          priceTicks={nasData}/>
      </div>
    )
  }
